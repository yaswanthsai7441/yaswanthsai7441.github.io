...
from Data_Handler import dataSubset
...
x_train, y_train = dataSubset('AAPL', '20180601', '20181229')
x_test, y_test = dataSubset('AAPL', '20181229', '20190521')
...
print(str(measure_accuracy(session.run(y_output, feed_dict={x_input: x_train}), y_train) -
          measure_accuracy(session.run(y_output, feed_dict={x_input: x_test}), y_test)))
